#ifndef __LIPP_ASYNC_H__
#define __LIPP_ASYNC_H__
...
public:
    ...
    LIPPAsync(double BUILD_LR_REMAIN = 0, bool QUIET = true)
...
public:
    ...
    class LIPPIterator {
        using lipp_type = LIPPAsync<T, P, USE_FMCD>;
