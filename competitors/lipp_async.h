...
#include "./lipp/src/core/lipp_async.h"
#include "base.h"

template<class KeyType>
class LippAsync: public Base<KeyType>
{
public:
    LippAsync(const std::vector<int>& params){}
    ...
    std::string name() const { return "LIPPAsync"; }
...
private:
    LIPPAsync<KeyType, uint64_t> lipp_;
